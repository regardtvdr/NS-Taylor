  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        ...
        'A deposit of R50 is required to secure your appointment booking.',
        'The deposit will be deducted from your total treatment cost on the day of your appointment.',
    ...
    },
    {
      ...
      content: [
        ...
        'Cancellations made less than 24 hours before the appointment may result in forfeiture of the deposit.',
        'Refunds for cancellations made more than 24 hours in advance will be processed within 5-7 business days.',
        'No-shows without prior cancellation will result in forfeiture of the deposit.',
        'We reserve the right to cancel appointments due to unforeseen circumstances, in which case your deposit will be fully refunded.',
    ...
    },
    {
      ...
      content: [
        ...
        'The deposit paid at booking will be deducted from the total amount due.',
        'We accept cash, credit cards, debit cards, and medical aid payments (where applicable).',
        'Payment processing is handled securely through third-party providers (Ozow, PayFast).',
