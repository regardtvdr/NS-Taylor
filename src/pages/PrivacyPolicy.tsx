...
const PrivacyPolicy = () => {
  const sections = [
    ...
    },
    {
      ...
      content: [
        'To process and manage your appointments and dental care',
    ...
    },
    {
      ...
      content: [
        ...
        'All payment transactions are processed through secure, PCI-compliant providers (Ozow, PayFast)',
    ...
    },
    {
      ...
      content: [
        ...
        'We may share information with payment processors (Ozow, PayFast) for transaction processing',
