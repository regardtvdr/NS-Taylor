...
export const DENTISTS: Dentist[] = [
  // Ruimsig Branch
  {
    ...
    bio: 'Dr Stefan Victor is an experienced dentist, passionate about fixed prosthodontics and restorative care—turning smiles back to life, one tooth at a time.',
    branch: 'Ruimsig',
  },
  {
    id: '2',
    ...
    reviews: 189,
    qualifications: 'BDS, MDS',
    bio: 'Dr Rivesh Singh has a keen interest in oral surgery and a strong passion for providing great quality treatment without compromising patient care.',
    branch: 'Ruimsig',
  },
  {
    id: '3',
    ...
    reviews: 156,
    qualifications: 'BDS, MDS',
    bio: 'Dr Ritesh Singh is an experienced practitioner with experience in crown and bridge work, dentures, fillings, and root canal treatments. He is passionate about helping patients achieve confident smiles and a better quality of life through attentive, high-quality care.',
    branch: 'Ruimsig',
  },
